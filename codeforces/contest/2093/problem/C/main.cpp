...
void solver(){
    int input(x, k); 
    if (k == 1){
        cout<<(isprime(x)?YES:NO)<<nl;
    }else if (x == 1){
        if (k == 2) cout<<(isprime(11)?YES:NO)<<nl;
        else if(k==3) cout<<(isprime(111)?YES:NO)<<nl;
        else if(k==4) cout<<(isprime(1111)?YES:NO)<<nl;
        else if(k==5) cout<<(isprime(11111)?YES:NO)<<nl;
        else if(k==6) cout<<(isprime(111111)?YES:NO)<<nl;
        else if(k==7) cout<<(isprime(1111111)?YES:NO)<<nl;
    }else cout<<NO<<nl;
}
